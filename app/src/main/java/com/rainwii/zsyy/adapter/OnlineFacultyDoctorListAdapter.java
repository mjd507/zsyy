 ...
 * 日期：2015/10/28 12:49
 */
public class OnlineFacultyDoctorListAdapter extends BaseAdapter {
    private Context context;
    private List<OnlineHotDoctor> hotDoctorList;

    public OnlineFacultyDoctorListAdapter(Context context, List<OnlineHotDoctor> hotDoctorList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.score.setRating(Integer.parseInt(hotDoctor.getScore()));
        return view;
    }
